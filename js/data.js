...
const getFontEndData = [
...

  {
    ...
    feature:
      "webpack,spinner dan placeholder,Authentication,HTTP Client dengan Axios,sass scss,bootstrap,Lit Element",
...
const myArray = no.feature.split(",");
console.log(myArray);
